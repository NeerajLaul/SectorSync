...
export function About({ onStartAssessment }: AboutProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="container mx-auto max-w-6xl px-4 py-16">
        {/* Header */}
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl mb-4">About SectorSync</h1>
        ...
        {/* How We're Different */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8 text-center">How SectorSync Is Different</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6">
              <div className="bg-blue-100 p-3 rounded-full w-fit mb-4">
                <Brain className="h-6 w-6 text-blue-600" />
              </div>
              <h3 className="text-xl mb-3">Evidence-Based Algorithm</h3>
            ...
            <Card className="p-6">
              ...
              <h3 className="text-xl mb-3">Contextual Intelligence</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              ...
              <h3 className="text-xl mb-3">Transparent Scoring</h3>
              <p className="text-muted-foreground">
        ...
        <section className="mb-16">
          <Card className="p-8">
            <h2 className="text-3xl mb-6">The Science Behind Our Recommendations</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl mb-2">Multi-Factor Sensitivity Analysis</h3>
                <p className="text-muted-foreground">
              ...
              <div>
                <h3 className="text-xl mb-2">Gate Rules</h3>
                <p className="text-muted-foreground">
              ...
              <div>
                <h3 className="text-xl mb-2">Nudge Algorithms</h3>
                <p className="text-muted-foreground">
              ...
              <div>
                <h3 className="text-xl mb-2">Version 3.0 Engine</h3>
                <p className="text-muted-foreground">
        ...
        {/* Who It's For */}
        <section className="mb-16">
          <h2 className="text-3xl mb-8 text-center">Who It's For</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6">
              <Users className="h-8 w-8 text-primary mb-4" />
              <h3 className="text-xl mb-3">Project Managers</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              ...
              <h3 className="text-xl mb-3">Team Leaders</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-6">
              ...
              <h3 className="text-xl mb-3">Consultants</h3>
              <p className="text-muted-foreground">
        ...
        <div className="text-center">
          <Card className="p-8 bg-gradient-to-r from-primary/10 to-purple-100/50">
            <h2 className="text-3xl mb-4">Ready to Find Your Perfect Methodology?</h2>
