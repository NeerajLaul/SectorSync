...
export function ToolGuide({ onStartAssessment }: ToolGuideProps) {
  return (
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <InteractiveCard className="glass-card p-6 border-white/20 dark:border-white/10 glass-hover group">
              ...
              <h3 className="text-xl mb-3">2. AI Analysis</h3>
              <p className="text-muted-foreground">
                Our advanced scoring engine analyzes your responses using sensitivity weights, 
                gate rules, and nudge algorithms to calculate compatibility scores for each methodology.
              </p>
            </InteractiveCard>
