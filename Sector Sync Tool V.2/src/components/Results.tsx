    ...
    <div className="relative min-h-screen py-10 px-4 overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-6xl space-y-6 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <InteractiveCard className="glass-card p-6 flex flex-col justify-between border-white/20 dark:border-white/10 transition-all duration-300 hover:scale-[1.02]">
            <div>
              <h3 className="text-lg font-semibold mb-2">
                Industry Benchmark
              </h3>
              <p className="text-sm text-muted-foreground mb-4">
                Compare your organization to leading peers:
                cadence, governance, sourcing, and delivery
                patterns.
              </p>
            </div>
            <div>
          ...
          <InteractiveCard className="glass-card p-6 flex flex-col justify-between border-white/20 dark:border-white/10 transition-all duration-300 hover:scale-[1.02]">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Present, print, or save these results for your
                team.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              {onOpenPitch && (
                <Button variant="outline" onClick={onOpenPitch}>
                  <Presentation className="h-4 w-4 mr-2" />
                  Pitch Mode
                </Button>
              )}
              {onOpenPrint && (
                <Button variant="outline" onClick={onOpenPrint}>
        ...
        <p className="text-center text-sm text-muted-foreground mt-8">
          ...
          Recommendations are guidance — apply judgment for your
          context.
        </p>
      </div>
    </div>
