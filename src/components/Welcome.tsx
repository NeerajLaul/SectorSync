      ...
      <div className="max-w-4xl w-full relative z-10">
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl mb-4">
            Project Methodology Advisor
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Find the perfect project management methodology for
        ...
        <Card className="glass-strong p-8 mb-8 shadow-2xl border-white/20 dark:border-white/10 transition-all duration-500 hover:scale-[1.01]">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="text-center group">
              ...
              <p className="text-sm text-muted-foreground">
                12 questions about your project context and
                preferences
              </p>
            </div>
          ...
          <div className="text-center">
            <Button
              onClick={onStart}
              size="lg"
              className="px-8 transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              Start Assessment
        ...
        <p className="text-center text-sm text-muted-foreground">
          This tool uses advanced scoring algorithms to match
          your project characteristics with the most suitable
          methodologies.
        </p>
      </div>
    </div>
